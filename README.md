...
Однако в зависимости от значения зума на UI возвращается то хранилище, которое соответствует текущему режиму просмотра. 
 ...
 ##### Оптимизация хранения альтернативной области видимости.
 
 Для корректной работы алгоритма достаточно хранить только P планет, c максимально близким к игроку значением рейтинга для каждой вертикали/горизонтали.
